...
* parameter[=].part[+].name = "site:nav:menu:organization:text"
* parameter[=].part[=].valueString = "Organizations"
* parameter[=].part[+].name = "site:nav:menu:organization:order"
* parameter[=].part[=].valueString = "14"
* parameter[=].part[+].name = "site:nav:menu:organization:icon"
* parameter[=].part[=].valueString = "mdi-folder-open"
* parameter[=].part[+].name = "site:nav:menu:organization:url"
...
* parameter[=].part[=].valueString = "Ranks"
...
* parameter[=].part[+].name = "site:nav:menu:database:menu:grade:text"
* parameter[=].part[=].valueString = "Grades"
* parameter[=].part[+].name = "site:nav:menu:database:menu:grade:url"
* parameter[=].part[=].valueString = "/resource/search/grade"
* parameter[=].part[+].name = "site:nav:menu:database:menu:grade:order"
* parameter[=].part[=].valueString = "2"
* parameter[=].part[+].name = "site:nav:menu:database:menu:step:text"
* parameter[=].part[=].valueString = "Step"
* parameter[=].part[+].name = "site:nav:menu:database:menu:step:url"
* parameter[=].part[=].valueString = "/resource/search/step"
* parameter[=].part[+].name = "site:nav:menu:database:menu:step:order"
* parameter[=].part[=].valueString = "3"
* parameter[=].part[+].name = "site:nav:menu:database:menu:identifier:text"
* parameter[=].part[=].valueString = "Personal Identifier Types"
...
* parameter[=].part[=].valueString = "4"
* parameter[=].part[+].name = "site:nav:menu:database:menu:empidentifier:text"
* parameter[=].part[=].valueString = "Employement Identifier Types"
* parameter[=].part[+].name = "site:nav:menu:database:menu:empidentifier:url"
* parameter[=].part[=].valueString = "/resource/search/empidentifier"
* parameter[=].part[+].name = "site:nav:menu:database:menu:empidentifier:order"
* parameter[=].part[=].valueString = "5"
* parameter[=].part[+].name = "site:nav:menu:database:menu:institution:text"
* parameter[=].part[=].valueString = "Institution"
...
* parameter[=].part[=].valueString = "6"
* parameter[=].part[+].name = "site:nav:menu:database:menu:appointment-status:text"
* parameter[=].part[=].valueString = "Appointment Status"
* parameter[=].part[+].name = "site:nav:menu:database:menu:appointment-status:url"
* parameter[=].part[=].valueString = "/resource/search/appointment-status"
* parameter[=].part[+].name = "site:nav:menu:database:menu:appointment-status:order"
* parameter[=].part[=].valueString = "7"
...
* parameter[=].part[=].valueString = "8"
* parameter[=].part[+].name = "site:nav:menu:database:menu:marital-status:text"
* parameter[=].part[=].valueString = "Marital Status"
* parameter[=].part[+].name = "site:nav:menu:database:menu:marital-status:url"
* parameter[=].part[=].valueString = "/resource/search/marital-status"
* parameter[=].part[+].name = "site:nav:menu:database:menu:marital-status:order"
* parameter[=].part[=].valueString = "9"
* parameter[=].part[+].name = "site:nav:menu:database:menu:relation:text"
* parameter[=].part[=].valueString = "Relationships"
* parameter[=].part[+].name = "site:nav:menu:database:menu:relation:url"
* parameter[=].part[=].valueString = "/resource/search/relation"
* parameter[=].part[+].name = "site:nav:menu:database:menu:relation:order"
...
* parameter[=].part[+].name = "site:nav:menu:database:menu:authority:text"
* parameter[=].part[=].valueString = "Issuing Authorities"
* parameter[=].part[+].name = "site:nav:menu:database:menu:authority:url"
* parameter[=].part[=].valueString = "/resource/search/id-issuing-authority"
* parameter[=].part[+].name = "site:nav:menu:database:menu:authority:order"
* parameter[=].part[=].valueString = "11"

* parameter[=].part[+].name = "site:nav:menu:database:menu:provider:text"
* parameter[=].part[=].valueString = "Provider"
* parameter[=].part[+].name = "site:nav:menu:database:menu:provider:url"
* parameter[=].part[=].valueString = "/resource/search/inservice-provider"
* parameter[=].part[+].name = "site:nav:menu:database:menu:provider:order"
* parameter[=].part[=].valueString = "12"

* parameter[=].part[+].name = "site:nav:menu:database:menu:submittingEntity:text"
* parameter[=].part[=].valueString = "Submitting Entity"
* parameter[=].part[+].name = "site:nav:menu:database:menu:submittingEntity:url"
* parameter[=].part[=].valueString = "/resource/search/submitting-entity"
* parameter[=].part[+].name = "site:nav:menu:database:menu:submittingEntity:order"
...
* parameter[=].part[=].valueString = "1"
// * parameter[=].part[+].name = "site:nav:menu:reports:menu:all-staff:text"
// * parameter[=].part[=].valueString = "All Practitioners"
// * parameter[=].part[+].name = "site:nav:menu:reports:menu:all-staff:url"
// * parameter[=].part[=].valueString = "/report/ihris-es-report-all-staff"
// * parameter[=].part[+].name = "site:nav:menu:reports:menu:all-staff:order"
// * parameter[=].part[=].valueString = "2"
...
// * parameter[=].part[=].valueString = "$1"
// * parameter[=].part[+].name = "defaults:fields:Practitioner.extension:citizenship.value[x]:valueReference:type"
// * parameter[=].part[=].valueString = "tree"
// * parameter[=].part[+].name = "defaults:fields:Person.extension:location.value[x]:type"
// * parameter[=].part[=].valueString = "tree"
// * parameter[=].part[+].name = "defaults:fields:Person.extension:location.value[x]:initialValue"
// * parameter[=].part[=].valueString = "Location/NG"
...
* parameter[=].part[+].name = "workflow:processor:practitionerrole:file"
* parameter[=].part[=].valueString = "workflowPractitionerRoleNg"
* parameter[=].part[+].name = "workflow:questionnaire:practitionerrole:url"
* parameter[=].part[=].valueString = "http://ihris.org/fhir/Questionnaire/ihris-practitionerrole"
...
* parameter[=].part[+].name = "workflow:processor:professionalInfo:file"
* parameter[=].part[=].valueString = "workflowProfessionNg"
* parameter[=].part[+].name = "workflow:questionnaire:professionalInfo:url"
* parameter[=].part[=].valueString = "http://ihris.org/fhir/Questionnaire/ihris-professional-practitioner"
* parameter[=].part[+].name = "workflow:processor:education:file"
* parameter[=].part[=].valueString = "workflowEducationHistoryNg"
...
* parameter[=].part[=].valueString = "workflowInServiceNg"
...
* parameter[=].part[+].name = "defaults:fields:Practitioner.extension:lgaBirth.value[x]:type"
* parameter[=].part[=].valueString = "tree"
* parameter[=].part[+].name = "defaults:fields:Practitioner.extension:citizenship.extension:lgaOfOrigin.value[x]:type"
* parameter[=].part[=].valueString = "tree"
* parameter[=].part[+].name = "defaults:fields:Practitioner.extension:residenceContact.extension:lgaOfResidence.value[x]:type"
* parameter[=].part[=].valueString = "tree"
* parameter[=].part[+].name = "defaults:fields:Practitioner.extension:permContact.extension:lgaOfResidence.value[x]:type"
* parameter[=].part[=].valueString = "tree"
* parameter[=].part[+].name = "defaults:fields:Organization.partOf:type"
* parameter[=].part[=].valueString = "tree"
* parameter[=].part[+].name = "defaults:fields:PractitionerRole.extension:unit.value[x]:type"
* parameter[=].part[=].valueString = "tree"
* parameter[=].part[+].name = "defaults:fields:PractitionerRole.location:type"
* parameter[=].part[=].valueString = "tree"
* parameter[=].part[+].name = "defaults:fields:Location.partOf:initialValue"
* parameter[=].part[=].valueString = "Location/State-1015" 
